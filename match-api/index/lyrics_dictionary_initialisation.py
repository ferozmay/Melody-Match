...
def save_lyrics_similarity_dict(lyrics_similarity_dict, path='data/stored_data/lyrics_similarity_dict.pkl'):
...
if __name__ == '__main__':
    ...
    # Output
    lyrics_all_words_path = 'data/stored_data/lyrics_all_words.txt'
    ...
    if make_fasttext_model:
        ...
        lyrics_similarity_dict = create_lyrics_similarity_dict(all_words, ft, save_path='data/stored_data/lyrics_similarity_dict.json', batch_size=100)

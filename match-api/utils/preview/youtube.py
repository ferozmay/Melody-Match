...
def search_youtube_id(track_info: dict):
    ...
    print(track_info)
    print(f"{track_info.get('title')} {track_info.get('artist')}")
    ...
    top_result_diff = abs(convert_to_milliseconds(top_result_length) - int(track_info.get("runtime", 0)))  # noqa: E501
    first_song_diff = abs(convert_to_milliseconds(first_song_length) - int(track_info.get("runtime", 0)))  # noqa: E501
    print(top_result_diff, first_song_diff)
